-- ============================================================================
-- SOLUÇÃO FINAL EFETIVA - FORÇA INSERÇÃO DE 25 SETORES E 625 NICHOS
-- ============================================================================
...
-- PASSO 2: DELETAR TODOS OS SETORES EXISTENTES
...
-- PASSO 5: INSERIR TODOS OS 625 NICHOS DE UMA VEZ
...
-- NOTA: Devido ao limite de tamanho, este script contém apenas os primeiros 2 setores como exemplo.
-- Para inserir TODOS os 625 nichos, você precisa executar o arquivo ADICIONAR_NICHOS_COMPLETO_B2B.sql
-- DEPOIS de executar este script (que cria os 25 setores).
