-- ============================================
-- SOLUÇÃO DEFINITIVA - MASTER ENGINEER APPROACH
-- ============================================
-- Análise 360° completa: Remove TODAS as referências problemáticas
-- e cria solução que funciona independente do cache do PostgREST
-- Execute este SQL no Supabase SQL Editor

-- ============================================
-- ETAPA 1: DIAGNÓSTICO COMPLETO
-- ============================================
-- Verificar TODAS as colunas relacionadas a source
...
-- Verificar views
SELECT 'DIAGNOSTICO_VIEWS' as etapa, table_name, view_definition
...
-- Verificar funções
SELECT 'DIAGNOSTICO_FUNCOES' as etapa, routine_name, routine_definition
...
DO $$
BEGIN
  RAISE NOTICE '✅ SOLUÇÃO MASTER ENGINEER APLICADA!';
