-- ==========================================
-- CORREÇÃO: Remover ambiguidade de processed_count em process_qualification_job
-- ==========================================
-- Problema: column reference "processed_count" is ambiguous
-- Solução: Qualificar todas as colunas com alias de tabela e renomear variáveis locais
