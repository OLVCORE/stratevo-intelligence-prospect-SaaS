-- ==========================================
-- ADICIONAR COLUNAS DE WEBSITE EM icp_analysis_results
-- ==========================================
-- Adiciona colunas website_encontrado, website_fit_score, linkedin_url
-- para exibição nas tabelas de Quarentena ICP e Leads Aprovados
...
-- Comentários
COMMENT ON COLUMN icp_analysis_results.website_encontrado IS 'Website oficial da empresa encontrado automaticamente via SERPER';
COMMENT ON COLUMN icp_analysis_results.website_fit_score IS 'Score de fit baseado em produtos encontrados no website (0-20 pontos)';
COMMENT ON COLUMN icp_analysis_results.website_products_match IS 'Array de produtos compatíveis encontrados no website';
COMMENT ON COLUMN icp_analysis_results.linkedin_url IS 'URL do LinkedIn da empresa (se encontrado)';
