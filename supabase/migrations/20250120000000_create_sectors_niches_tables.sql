-- ============================================================================
-- MIGRATION: Criar tabelas SETORES e NICHOS
-- ============================================================================
-- Esta migration cria as tabelas sectors e niches com todos os dados necessários
-- Execute via: supabase migration up ou diretamente no Supabase SQL Editor
-- ============================================================================
...
-- Política RLS: Permitir leitura para TODOS (autenticados E anônimos)
...
-- ========================================
-- TABELA: Nichos (100+ nichos detalhados)
-- ========================================
