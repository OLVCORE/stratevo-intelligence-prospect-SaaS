-- ============================================================================
-- MIGRATION: CRM Multi-Tenant Base Infrastructure
-- ============================================================================
-- Data: 2025-01-22
-- Descrição: Cria infraestrutura base para CRM multi-tenant
-- ============================================================================
...
-- COMENTÁRIOS
-- ============================================
COMMENT ON TABLE public.tenant_users IS 'Relação muitos-para-muitos entre usuários e tenants com roles e permissões';
COMMENT ON FUNCTION public.get_current_tenant_id IS 'Retorna o tenant_id do usuário autenticado atual';
COMMENT ON FUNCTION public.has_tenant_role IS 'Verifica se o usuário atual tem um role específico no tenant';
