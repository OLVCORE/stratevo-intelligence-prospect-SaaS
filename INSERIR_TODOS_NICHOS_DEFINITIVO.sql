-- ============================================================================
-- INSERIR TODOS OS NICHOS DEFINITIVO (25 setores x 25 nichos = 625 nichos)
-- ============================================================================
-- Execute este script DEPOIS de executar ADICIONAR_SETORES_PRINCIPAIS_B2B.sql
-- Este script DELETA nichos antigos e INSERE todos os novos
-- ============================================================================
...
-- ============================================================================
-- DELETAR TODOS OS NICHOS EXISTENTES DOS 25 SETORES
-- ============================================================================
...
-- ============================================================================
-- INSERIR TODOS OS NICHOS (625 no total)
-- ============================================================================
...
-- Continuar inserindo os outros 23 setores...
-- (Devido ao tamanho, vou criar um segundo arquivo com os setores restantes)

NOTIFY pgrst, 'reload schema';

SELECT 
    '✅ PRIMEIRA PARTE INSERIDA' as status,
    (SELECT COUNT(*) FROM public.niches WHERE sector_code IN ('agro', 'manufatura')) as nichos_inseridos;
