-- ==========================================
-- APLICAR MIGRATION: qualified_stock_enrichment
...
DROP POLICY IF EXISTS "Users can view enrichments from their tenant" ON public.qualified_stock_enrichment;
...
DROP POLICY IF EXISTS "Users can manage enrichments from their tenant" ON public.qualified_stock_enrichment;
...
DROP TRIGGER IF EXISTS trigger_update_qualified_stock_enrichment_updated_at ON public.qualified_stock_enrichment;
