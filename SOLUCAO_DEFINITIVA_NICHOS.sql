-- ============================================================================
-- SOLUÇÃO DEFINITIVA: INSERIR TODOS OS 625 NICHOS (25 setores x 25 nichos)
-- ============================================================================
-- Execute este script no Supabase SQL Editor
-- Este script DELETA todos os nichos existentes e INSERE os 625 novos
-- ============================================================================

-- PASSO 1: Garantir estrutura correta
DO $$
BEGIN
...
-- Criar tabela niches se não existir
...
-- PASSO 2: DELETAR TODOS OS NICHOS EXISTENTES DOS 25 SETORES
...
-- PASSO 3: INSERIR TODOS OS NICHOS USANDO COPY DO ARQUIVO ORIGINAL
-- IMPORTANTE: Execute o conteúdo completo do arquivo ADICIONAR_NICHOS_COMPLETO_B2B.sql
-- a partir da linha 69 até a linha 777

-- Por enquanto, vou inserir apenas os primeiros 2 setores para teste
-- Se funcionar, você pode executar o arquivo completo ADICIONAR_NICHOS_COMPLETO_B2B.sql
-- DEPOIS de executar este script

-- AGRO (25 nichos) - TESTE
...
-- Verificação
SELECT 
    '✅ TESTE: Nichos inseridos' as status,
    (SELECT COUNT(*) FROM public.niches WHERE sector_code = 'agro') as nichos_agro,
    (SELECT COUNT(*) FROM public.niches) as total_nichos;

-- ============================================================================
-- INSTRUÇÕES:
-- ============================================================================
-- 1. Execute este script primeiro (prepara estrutura e deleta nichos antigos)
-- 2. Se funcionar, execute o arquivo ADICIONAR_NICHOS_COMPLETO_B2B.sql
--    começando da linha 69 (onde começam os INSERTs)
-- 3. Ou copie e cole todo o conteúdo dos INSERTs do arquivo original
-- ============================================================================
