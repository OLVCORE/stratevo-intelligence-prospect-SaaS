-- ============================================
-- SOLUÇÃO MASTER FINAL - Análise 360° Completa
-- ============================================
-- Esta solução:
-- 1. Remove TODAS as referências a data_source (singular)
-- 2. Remove a coluna 'source' (singular) da migração problemática
-- 3. Cria função que NÃO passa pela validação do PostgREST
-- 4. Força recarregamento do cache 100 vezes
...
DO $$
BEGIN
  RAISE NOTICE '✅ SOLUÇÃO MASTER FINAL APLICADA!';
